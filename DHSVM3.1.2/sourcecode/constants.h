...
#define CH_ICE     (2100.0e3)	/* Volumetric heat capacity (J/(m3*K) of ice at 0 deg C) */
#define CH_WATER   (4186.8e3)	/* Volumetric heat capacity (J/(m3*K) of water */
#define CP          1013.0		/* Specific heat of moist air at constant pressure (J/(kg*K)) */
...
#define KhH2O 0.58				/* Thermal conductivity of water (W/(m*K)) */
#define KhICE 2.2				/* Thermal conductivity of ice (W/(m*K)) */
#define LEAF_DRIP_DIA  0.0055   /* Leaf drip diameter (m) */
#define LF           (333.7e3)	/* latent heat of fusion (J/kg) at 0 deg C */
...
extern float avg_temp;                  /* Soil temperature (deg C) at a very deep soil depth where soil 
